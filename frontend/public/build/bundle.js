...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "svelte-pfz1fu");
    			add_location(p, file$1, 35, 8, 1065);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 29, 4, 818);
    			attr_dev(input0, "type", "email");
    			attr_dev(input0, "placeholder", "email@email.com");
    			attr_dev(input0, "class", "svelte-pfz1fu");
    			add_location(input0, file$1, 30, 4, 838);
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "placeholder", "Password");
    			attr_dev(input1, "class", "svelte-pfz1fu");
    			add_location(input1, file$1, 31, 4, 915);
    			attr_dev(button, "class", "svelte-pfz1fu");
    			add_location(button, file$1, 32, 4, 991);
    			attr_dev(main, "class", "svelte-pfz1fu");
    			add_location(main, file$1, 28, 0, 806);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	async function login() {
    		try {
    			...
    			if (data.success) {
    				...
    				$$invalidate(2, message = data.error || data.message);
    			}
    		} catch(err) {
    	...
    	return [email, password, message, login, input0_input_handler, input1_input_handler];
    }
